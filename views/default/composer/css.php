...
.close_tool{
    ...
    height: 16px;
    float: right;
    background:url('<?php echo elgg_get_site_url(); ?>mod/composer/graphics/close.png') no-repeat center center;
    cursor:pointer;
}

#composer select{
  background: url("<?php echo elgg_get_site_url();?>mod/composer/graphics/config.png") no-repeat scroll right center #fff;
